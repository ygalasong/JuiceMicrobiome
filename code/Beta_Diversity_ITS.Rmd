...
Note: the code in the next four chunks won't be run. It is only for showing the workflow using popular packages. For this project, we will use a rather novel method implemented in `tempted` package.

...
obs_rich_oj %>%
  ...
  #theme(axis.text.x = element_text(angle = 45))
  theme_pubr()
# This plot below shows that in non-thermally processed cider, the richness in spoiled cider are significantly lower than samples that are not spoiled.
